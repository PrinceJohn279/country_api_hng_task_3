...
class MyTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.black),
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 42.0, fontWeight: FontWeight.bold, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.white),
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 42.0, fontWeight: FontWeight.normal, color: Colors.white),
