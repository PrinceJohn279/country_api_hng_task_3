...
class MobileDetailsUi extends StatefulWidget {
  final Country country;
  const MobileDetailsUi({super.key, required this.country});

  @override
  _MobileDetailsUiState createState() => _MobileDetailsUiState();
}

class _MobileDetailsUiState extends State<MobileDetailsUi> {
